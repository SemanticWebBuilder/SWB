...
<%@page import="org.semanticwb.platform.*,org.semanticwb.portal.api.*,org.semanticwb.portal.resources.sem.video.*,org.semanticwb.*,org.semanticwb.model.*,java.util.*"%>
                ...
                <div>
                    <div>
                        <p>
                            ...
                            <textarea id="video_code" rows="10" cols="60" name="video_code"><%=rec.getVideoCode()%></textarea>
                        </p>
                        <p>
