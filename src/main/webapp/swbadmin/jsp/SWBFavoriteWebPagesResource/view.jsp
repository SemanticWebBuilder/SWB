...
%>
        <input type="button" value="Agregar como favoritos" class="bkmrk" onclick="postHtml('<%=url%>','fv_<%=id%>')"/>
<%                        
    }
    else
    {
...
%>
        <input type="button" value="Quitar de favoritos" class="unbkmrk" onclick="postHtml('<%=url%>','fv_<%=id%>')"/>
<%
    }
%>